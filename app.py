...
# CONFIG
# =============================
API_BASE = "https://movie-recommender-internship.onrender.com"
...
def api_get_json_with_retry(
    ...
    """
    Retries only when the backend is temporarily unavailable
    (Render cold start: 502/503/504).
    """
    ...
    for attempt in range(max_retries):
        ...
        try:
            ...
            progress.empty()
            return None, "Unable to connect to backend."
...
if st.session_state.view == "home":
    ...
    with st.spinner("Loading movies... (The server may take a few seconds to wake up)"):
        with st.spinner("Loading movies..."):
            home_cards, err = api_get_json_with_retry(
                "/home",
                params={
